from sqlalchemy import Numeric, SmallInteger, BigInteger, DateTime, Text, Column, String
...
class Material(Base):
    ...
    material_code = Column(String, nullable=False, comment='物料编码')
    material_name = Column(String, nullable=False, comment='物料名称')
